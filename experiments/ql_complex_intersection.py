...
if __name__ == '__main__':
    ...
    env = SumoEnvironment(net_file='nets/complex_intersection/complex.net.xml',
                          route_file='nets/complex_intersection/complex.rou.xml',
                          out_csv_name='outputs/complex',
                          use_gui=True,
                          num_seconds=80000,
                          max_depart_delay=0)
